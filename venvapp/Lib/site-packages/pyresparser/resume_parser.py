...
class ResumeParser(object):
    ...
    def __init__(
        ...
        self.__details = {
            ...
            'skills': None,
            'degree': None,
            'experience': None,  # Added 'experience' field
            'no_of_pages': None,
        }
        ...
        self.__text = utils.extract_text(self.__resume, '.' + ext)
    ...
    def __get_basic_details(self):
        ...
        experience = utils.extract_experience(self.__text)  # Extract experience from raw text

        entities = utils.extract_entity_sections_grad(self.__text)
